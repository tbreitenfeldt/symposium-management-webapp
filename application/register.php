...
<main>
  ...
  <div class="form-group row">
    <label for="user_phone" class="col-sm-3 col-form-label">Phone Number</label>
    <div class="col-sm-9">
  ...
  <div class="form-group row">
    <div class="form-check">
      <label for="user_notifyByEmail"><strong>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></label>
  ...
  <div class="form-group row">
    <div class="form-check">
      <label for="user_notifyByPhone"><strong>Text Message</strong></label>
